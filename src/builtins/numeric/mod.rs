...
impl BuiltIns {
    ...
    pub(crate) fn number(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn ceil(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn round(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn power(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn sqrt(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    /// ```
    /// **Signature**: `$random()`
    pub(crate) fn random(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn format_number(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn format_base(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn format_integer(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
    ...
    pub(crate) fn parse_integer(args: &[JSONataValue]) -> EvaluationResult {
        todo!()
    }
}
